...
type SocialKey = typeof socialInputs[number]['key']
    ...
    <OnboardingLayout>
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-500">
          Compartilhe suas contas para personalizar sua experiência
        </p>
        ...
        {socialInputs.map((social, index) => (
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                type="text"
                value={(data[social.key as keyof typeof data] as string) || ''}
