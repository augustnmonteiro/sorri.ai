        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Link
                to="/forgot-password"
                className="inline-block mt-2 text-sm text-primary hover:text-primary-dark"
              >
                Esqueceu sua senha?
              </Link>
            </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary to-secondary items-center justify-center p-12">
        <div className="max-w-lg text-white">
          <h2 className="text-4xl font-bold mb-4">
            Marketing que funciona para dentistas
          </h2>
          <p className="text-xl text-white/80">
            Gere roteiros com IA, acompanhe seus vídeos e receba edições profissionais. Tudo em um só lugar.
          </p>
        </div>
      </div>
    </div>
